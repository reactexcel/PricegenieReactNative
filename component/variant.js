...
export class VariantPoduct extends Component {
    ...
    render() {
        ...
        let variant_product = _.map(dataPoints, (data, key) => {
            return (
                <View key={key} style={{
                    marginTop: 5,
                    borderTopWidth: 1,
        ...
        return (
            <View style={{
                ...
                <Icon.ToolbarAndroid logo={require('../img/genie-logo-g.png')} onIconClicked={this._previouspage} navIconName="ios-arrow-back" title='' style={style.toolbar} titleColor='white' overflowIconName="md-more" action={[]} elevation={4}></Icon.ToolbarAndroid>
                <View style={{
                    flexDirection: 'row',
